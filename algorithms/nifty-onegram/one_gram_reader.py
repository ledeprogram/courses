...
def read_entire_wfile(wfilename): 
    input_file = open(wfilename, "rb") 
...
def read_wfile(word, year_range, wfilename):               
    input_file = open(wfilename, "rb") 
    csv_reader = csv.reader(input_file, delimiter="\t") 
...
def read_total_counts(tfilename):      
    input_file = open(tfilename, "rb") 
    csv_reader = csv.reader(input_file, delimiter=",") 
